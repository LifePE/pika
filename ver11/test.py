...
def runGame():
    ...
    while True:
        ...
        acc=6
        if (p1_y>=pos_y and p1_y<pos_y+(judgeRage+5)) and (p1_x<=pos_x+judgeRage and p1_x>pos_x):
            vel_x=0
            vel_y=0
            acc_x=-acc
            acc_y=-(acc-2)
            p1_x+=vec*2
            p1_y+=(vec/2)*2
        if (p1_y>pos_y-(judgeRage+5) and p1_y<pos_y) and (p1_x<=pos_x+judgeRage and p1_x>pos_x):
            vel_x=0
            vel_y=0
            acc_x=-acc
            acc_y=(acc-2)
        ...
        if (p1_x>pos_x-judgeRage and p1_x<pos_x) and (p1_y<=pos_y+(judgeRage+5) and p1_y>pos_y):
            vel_x=0
            vel_y=0
            acc_x=(acc-2)
            acc_y=-acc
            p1_x-=(vec/2)*2
            p1_y+=vec
        if (p1_x>=pos_x and p1_x<pos_x+judgeRage) and (p1_y<=pos_y+(judgeRage+5) and p1_y>pos_y):
            vel_x=0
            vel_y=0
            acc_x=-(acc-2)
            acc_y=-acc
...
'''
        if (p2_y>=pos_y and p2_y<pos_y+judgeRage) and (p2_x<=pos_x+judgeRage and p2_x>pos_x):
            vel_x=0
            vel_y=0
            acc_x=-acc
            acc_y=-(acc-2)
            p2_x+=vec*2
            p2_y+=(vec/2)*2
        if (p2_y>pos_y-judgeRage and p2_y<=pos_y) and (p2_x<=pos_x+judgeRage and p2_x>pos_x):
            vel_x=0
            vel_y=0
            acc_x=-acc
            acc_y=(acc-2)
        ...
        if (p2_x>pos_x-judgeRage and p2_x<=pos_x) and (p2_y<=pos_y+judgeRage and p2_y>pos_y):
            vel_x=0
            vel_y=0
            acc_x=(acc-2)
            acc_y=-acc
            p2_x-=(vec/2)*2
            p2_y+=vec
        if (p2_x>=pos_x and p2_x<pos_x+judgeRage) and (p2_y<=pos_y+judgeRage and p2_y>pos_y):
            vel_x=0
            vel_y=0
            acc_x=-(acc-2)
            acc_y=-acc

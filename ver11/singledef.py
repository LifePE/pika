...
def goLeft():
    global p2_x,p2_y,p1_x,p1_y,vel2,pMode2
    if p2_x>=25:
        p2_x-=vel2
        pMode2+=1
...
def runGame():
    global screen,p1,p2,p12,p22,ball,clock,p1_x,p1_y,p2_x,p2_y,pos_x,pos_y,goal1,goal2,win,lose,pMode1,pMode2
...
#0=공 1=수
        ...
        if ver==2:
            pass
        if ver==0:
            if p2_x<pos_x-59 and p2_x<680:
                goRight()
            if p2_x>=pos_x+59 and p2_x>160:
                goLeft()
            if p2_y<pos_y+40 and p2_y<400:
                goDown()
            if p2_y>pos_y-40 and p2_y>80:
                goUp()
            if p2_x<300 and p2_x>100:
                boost2=False
            else:
                boost2=True
